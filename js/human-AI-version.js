...
function startStandaloneExperiment(experimentType) {
    try {
        ...
        // Log RL agent type selected in configuration
        if (window.NodeGameConfig && window.NodeGameConfig.getRLAgentType) {
            console.log('RL agent type (from config):', window.NodeGameConfig.getRLAgentType());
        }
